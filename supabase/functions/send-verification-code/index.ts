...
serve(async (req) => {
  ...
  try {
    console.log('🔍 Send verification code request started')
    ...
    console.log('📧 Email verification request:', { email, type })
    ...
    console.log('🔢 Generated verification code:', { code, expiresAt })
    ...
    console.log('✅ Verification code process completed successfully')
